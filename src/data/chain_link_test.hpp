...
* new number.
* - Then, it fills out the rest of the structure with the first 6
* even factors it can find of that number, before continuing.
...
#define AFK_CLTL_FACTOR_COUNT 6
...
protected:
    uint32_t rnum;
    uint32_t usageCount;
    uint32_t factors[AFK_CLTL_FACTOR_COUNT];
