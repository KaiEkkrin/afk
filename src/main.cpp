...
#include "rng/aes.hpp"
#include "rng/boost_mt19937.hpp"
#include "rng/boost_taus88.hpp"
#include "rng/c.hpp"
#include "rng/hmac.hpp"

/* This is the AFK global core declared in core.h */
AFK_Core afk_core;


void evaluate_rng(AFK_RNG& rng, const std::string& name, const AFK_Cell* testCells, const size_t testCellCount, const size_t randsPerCell)
{
...
int main(int argc, char **argv)
{
    ...
    /* I'm going to use the basic C RNG to produce the
     * test cells to drive all the others with.
     * :P
     */
    boost::random::random_device rdev;
    srand(rdev());

    /* TODO If I'm going to be using OpenSSL, the default
